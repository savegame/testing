...
| NFS-ModTools (format reference) | https://github.com/NFSTools/NFS-ModTools | master (fetched 2026-07-13) | no license file | MW solid geometry chunk/struct layouts (SolidReader.cs, MostWantedSolidReader.cs) used as documentation for `formats/Solids`; code re-implemented |
